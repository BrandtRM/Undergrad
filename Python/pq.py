...
class PriorityQueue:
    ...
    def _children(self, i):
        # Returns a range containing 0, 1, or 2 indices.
        return range(self._left(i), min(len(self), self._right(i) + 1))
    ...
    def findmin(self):
        try:
            ...
            raise RuntimeError('Illegal operation on empty PriorityQueue.')
